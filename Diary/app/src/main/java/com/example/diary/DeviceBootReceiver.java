...
public class DeviceBootReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if(Objects.equals(intent.getAction(), "android.intent.cation.BOOT_COMPLETED")){
            ...
            Toast.makeText(context.getApplicationContext(), "알람 설정이 완료되었습니다!", Toast.LENGTH_SHORT).show();
